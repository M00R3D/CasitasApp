<template>
  <ion-app>
    <!-- ✅ Insertamos la navbar personalizada arriba -->
    <Navbar :appPages="appPages" /> 
        ...
        <ion-content>
          ...
          <ion-list id="labels-list">
            ...
            <ion-item v-for="(label, index) in labels" lines="none" :key="index">
              <ion-icon aria-hidden="true" slot="start" :ios="bookmarkOutline" :md="bookmarkSharp" />
...
import Navbar from './components/Navbar.vue'; // ✅ Importa tu componente Navbar
import {
  IonApp,
  IonContent,
  IonIcon,
